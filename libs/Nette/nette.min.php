...
/**
 * Nette Framework (version 2.0-dev released on 2011-10-30, http://nette.org)
 *
...
final class Framework
{
	...
	const NAME = 'Nette Framework',
		VERSION = '2.0-beta',
		REVISION = '1d090ff released on 2011-10-30';
...
use Nette\Utils\PhpGenerator\Helpers;use Nette\Utils\PhpGenerator\PhpLiteral;
...
class ContainerBuilder extends Nette\Object
{
	...
	function addDefinition($name, $class, $prefer = FALSE)
	{
...
class ServiceDefinition extends Nette\Object
{
	...
	function addCall($method, array $args = NULL)
	{
		$this->calls[] = array($method, $args);
		return $this;
	}

	function addTag($tag, $attrs = NULL)
	{
...
class Helpers
{
	...
	static function dumpMember($var)
	{
	...
	static function generate($statement)
	{
		$args = func_get_args();
		unset($args[0]);
